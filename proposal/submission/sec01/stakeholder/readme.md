...
- Payment management: <br>Students can use the system to pay their lodging costs via the payment management tool. The system should enable students to monitor their payment history and receipts and offer safe payment options like internet banking and also convenient payment method, such as TnG e-wallet. The payment will then directly link to the UTM bussary system.
