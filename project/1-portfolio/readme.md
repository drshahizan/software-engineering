...
-->
```
4. You must place your file in the [submission](./submission) folder. Within the [sec01](./sec01) or [sec02](./sec02) folder, create a folder called your `id github`. Name the file as `P1_Githubid.html`.
  > Example: 
  > /submission/drshahizan/P1_drshahizan.html
