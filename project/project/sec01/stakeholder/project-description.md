...
During the implementation of the Student Accommodation System at KTDI, the development team undertook several tasks and activities to create a comprehensive and functional system. The following tasks were performed:

1. Requirements gathering and analysis: The team interacted with stakeholders, conducted interviews, and analyzed existing systems to gather functional and non-functional requirements for the Student Accommodation System.

2. Database design: The team designed the database schema, defined relationships between entities, and optimized the database structure for efficient data storage and retrieval. The database stored information about users, accommodations, bookings, maintenance requests, and payment records.

3. User interface design: The team created wireframes and prototypes for the system's user interface. They focused on usability, accessibility, and user experience principles to ensure a seamless and intuitive user interface.

4. Backend development: The team implemented the server-side logic using a suitable programming language. They developed modules for user management, accommodation listings, booking and reservation, maintenance requests, notifications, reporting, and analytics.

5. Frontend development: The team implemented the user interface using HTML, CSS, and JavaScript. They integrated the frontend with the backend modules to provide a responsive and interactive user interface for students, administrators, fellows, and staff.

6. Authentication and security: The team implemented secure authentication mechanisms, such as username/password login and role-based access control. They ensured data security by implementing encryption techniques and following secure coding practices.

7. Testing: The team performed various types of testing, including unit testing, integration testing, and system testing. They identified and fixed any issues or bugs to ensure the correctness and reliability of the system.

8. Deployment: The team deployed the system on appropriate servers or cloud platforms. They configured the necessary infrastructure and ensured scalability and performance to handle a large number of users and data.

9. Training and support: The team conducted training sessions for system users to familiarize them with the Student Accommodation System. They provided documentation, user manuals, and offered ongoing technical support and maintenance.

The implemented Student Accommodation System comprised several software components/modules, including:

1. Authentication Module:

- User sign up or sign in (UC01): Allows students, administrators, fellows, and staff to register or log in to the web application using their UTM ID and password.
- Password setting (UC02): Enables users to reset their passwords for accessing the system.

2. Centralized Dashboard Module:

- Update and view user profile (UC03): Allows students, administrators, fellows, and staff to update and view their user profiles displayed on the dashboard.
- Update hostel information (UC04): Allows administrators, fellows, and staff to update the latest information about KTDI.
- View hostel information (UC05): Enables students to view the latest KTDI information from the hostel authority on the dashboard.

3. Reporting and Analytics Module:

- View room occupancy report (UC06): Allows administrators to access the system-generated room occupancy report.
- View revenue report (UC07): Allows administrators to view the revenue report automatically generated by the system.
- View room maintenance record (UC08): Enables administrators to access the system-generated room maintenance record.
- Enter student college merits (UC09): Allows fellows to insert the college merits of each student in KTDI.
- View quota active report (UC10): Enables fellows and administrators to view the quota active report generated by the system.
